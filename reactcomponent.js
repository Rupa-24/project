      ...
      <div>
        <div class="d-flex justify-content-center mt-5">
          <form class="shadow-lg p-3 mb-5 bg-body rounded pt-4">
              ...
              <div class="col-sm-10">
                <div class="male">
                  <input
                    ...
                    value="option1"
                  />
                  <label class="form-check-label" for="gridRadios1" id="male">
                    Male
                  </label>
                </div>
                <div class="female">
                  <input
                    ...
                    value="option2"
                  />
                  <label class="form-check-label" for="gridRadios2" id="female">
                    Female
                  </label>
                </div>
              </div>
            ...
            <div class="row mb-3">
              <label for="clg" class="col-sm-2 col-form-label">
                College
              </label>
              <div class="col-sm-10">
                <select
            ...
            <button type="submit" class="btn btn-primary" onclick="sub()">
              Submit
            </button>
          </form>
        </div>
